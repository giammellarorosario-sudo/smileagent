...
const initializeDatabase = () => {
  ...
  // 🔐 Tabella OAuth Tokens (Gmail, Calendar, etc.)
  db.exec(`
    CREATE TABLE IF NOT EXISTS oauth_tokens (
      ...
      UNIQUE(studio_id, servizio),
      FOREIGN KEY (studio_id) REFERENCES studios(id) ON DELETE CASCADE
    );
  `);

  // 📧 Tabella Email Threads Tracking (per AI auto-reply)
  db.exec(`
    CREATE TABLE IF NOT EXISTS email_threads (
      ...
      needs_human_attention INTEGER DEFAULT 0,
  ...
  // 📱 Tabella Social Calendar (calendario editoriale condiviso)
  db.exec(`
